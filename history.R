...
cwl_history <- function(input, output, session, parent_session, poolConn, deploy){
  ...
  #when a line in the calendar is clicked, update the histroy refresh and switch tabs
