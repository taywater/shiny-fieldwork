...
#I added global variables to both UI and server (and added function(req){}) to UI)  in app.R because because they need to be checked by each every time the app runs, not just when it is deployed. 
